        ...
        <div class="bg-white dark:bg-gray-800 rounded-[28px] shadow-2xl p-10">
            <div class="flex flex-col items-center mb-8">
                ...
                <div class="text-center">
                    <h1 class="text-[#0b1a34] dark:text-[#FFFF] mb-2">Login Dosen</h1>
            ...
            <form action="{{ route('login.dosen') }}" method="POST" class="space-y-5">
                ...
                <div>
                    <label for="email" class="block text-gray-700 dark:text-[#FFFF] mb-2">Email</label>
                    <div class="relative">
                        ...
                        <input id="email" type="email" name="email"
                            class="w-full pl-12 pr-4 py-3.5 border border-gray-200 rounded-xl
                            focus:ring-2 focus:ring-[#2563EB] bg-gray-50 dark:bg-gray-100 hover:bg-white transition-all"
                            placeholder="dosen@university.ac.id" required autofocus />
                    </div>
                </div>

                <div>
                    <label for="password" class="block text-gray-700 dark:text-[#FFFF] mb-2">Password</label>
                    <div class="relative">
                        <svg xmlns="http://www.w3.org/2000/svg"
                            class="absolute left-4 top-1/2 -translate-y-1/2 text-gray-400 w-5 h-5"
                            fill="none" viewBox="0 0 24 24" stroke="currentColor">
