...
<div x-data="{ sidebarOpen: true }" class="min-h-screen bg-slate-50">
    ...
    <div class="flex">
        ...
        @include('components.sidebar', [
            'menuItems' => [
                ['id' => 'dashboard', 'label' => 'Dashboard', 'icon' => 'layout-dashboard', 'route' => 'mahasiswa.dashboard'],
                ['id' => 'isi-krs', 'label' => 'Isi KRS', 'icon' => 'file-edit', 'route' => 'mahasiswa.krs'],
                ['id' => 'jadwal-kuliah', 'label' => 'Jadwal Kuliah', 'icon' => 'calendar', 'route' => 'mahasiswa.jadwal'],
                ['id' => 'nilai', 'label' => 'Nilai', 'icon' => 'award', 'route' => 'mahasiswa.nilai'],
                ['id' => 'pengumuman', 'label' => 'Pengumuman', 'icon' => 'megaphone', 'route' => 'mahasiswa.pengumuman'],
